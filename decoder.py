...
class MyViterbiDecoder:
    ...
    def backtrace(self):
        ...
        # first find the best final state
        ...
        # backward walk through the trellis
        while t >= 0:
            # get which state i was produced at time t-1 with the lowest cost into state j at time t
            i = self.B[t][j]
            # this state i is the best state for this step
            ...
            j = i  
            t-=1
        # make sure that the output best sequence is from 0...T
